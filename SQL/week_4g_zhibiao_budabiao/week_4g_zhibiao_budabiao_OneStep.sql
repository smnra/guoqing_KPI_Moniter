select tab1.地市,tab1.lncel_enb_id,
tab1.lncel_lcr_id, round(avg(设备完好率),2) "设备完好率",
round(avg(zb)*100,2) "CQI≤4占比"
 from (select substr((CASE
          ...
          lncel.lncel_lcr_id,
               ...
               group by substr((CASE
                               ...
                               END),
                               0,
                               2),lncel.lncel_enb_id,
          lncel.lncel_lcr_id) tab1,
       (
       select substr((CASE
  ...
  decode(
        sum(NOKLTE_PS_LPQDL_MNC1_RAW.UE_REP_CQI_LEVEL_00 +
                   ...
                   NOKLTE_PS_LPQDL_MNC1_RAW.UE_REP_CQI_LEVEL_15),
                   0,
                   0,
                sum(NOKLTE_PS_LPQDL_MNC1_RAW.UE_REP_CQI_LEVEL_00 +
                   NOKLTE_PS_LPQDL_MNC1_RAW.UE_REP_CQI_LEVEL_01 +
               ...
               sum(NOKLTE_PS_LPQDL_MNC1_RAW.UE_REP_CQI_LEVEL_00 +
                   ...
                   NOKLTE_PS_LPQDL_MNC1_RAW.UE_REP_CQI_LEVEL_14 +
                   NOKLTE_PS_LPQDL_MNC1_RAW.UE_REP_CQI_LEVEL_15)
                   ) zb  from c_lte_lncel lncel, c_lte_lnbts lnbts, NOKLTE_PS_LPQDL_MNC1_RAW
...
and tab1.lncel_enb_id = tab2.lncel_enb_id(+) 
and tab1.lncel_lcr_id = tab2.lncel_lcr_id(+)
and tab1.地市 <>'A'
group by tab1.地市,tab1.lncel_enb_id,
tab1.lncel_lcr_id