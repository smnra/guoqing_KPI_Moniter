select 
    ...
    TTime,
    区域,
        Round(Decode(sum(LTE系统内切换成功率_Y),0,0,100 * sum(LTE系统内切换成功率_X) /
                     sum(LTE系统内切换成功率_Y)), 2) as "LTE系统内切换成功率",     
        --sum(LTE系统内切换成功率_X) as "LTE系统内切换成功率_X",
        --sum(LTE系统内切换成功率_Y) as "LTE系统内切换成功率_Y",
        
        sum(eNB内切换请求次数) as "eNB内切换请求次数",
        sum(eNB内切换成功次数) as "eNB内切换成功次数",
        Round(decode(sum(eNB内切换成功率_Y), 0, 0, 100 * sum(eNB内切换成功率_X) / 
                     sum(eNB内切换成功率_Y)),2) as "eNB内切换成功率",
        --sum(eNB内切换成功率_X) AS "eNB内切换成功率_X",
        --sum(eNB内切换成功率_Y) AS "eNB内切换成功率_Y",
        
        sum(X2切换出请求次数) as "X2切换出请求次数",
        sum(X2切换出成功次数) as "X2切换出成功次数",
        Round(decode(sum(X2切换成功率_Y), 0, 0, 100 * sum(X2切换成功率_X) / 
                     sum(X2切换成功率_Y)),2) as "X2切换成功率",
        --sum(X2切换成功率_X) as "X2切换成功率_X",
        --sum(X2切换成功率_Y) as "X2切换成功率_Y",

        sum(S1切换出请求次数) as "S1切换出请求次数",
        sum(S1切换出成功次数) as "S1切换出成功次数",
        Round(decode(sum(S1切换成功率_Y), 0, 0, 100 * sum(S1切换成功率_X) /
                     sum(S1切换成功率_Y)),2) as "S1切换成功率",
        --sum(S1切换成功率_X) as "S1切换成功率_X",
        --sum(S1切换成功率_Y) as "S1切换成功率_Y",

        sum(LTE至WCDMA切换请求次数) as "LTE至WCDMA切换请求次数",
        sum(LTE至WCDMA切换成功次数) as "LTE至WCDMA切换成功次数",
        Round(decode(sum(LTE至WCDMA切换成功率_Y), 0, 0, 100 * sum(LTE至WCDMA切换成功率_X) / 
                     sum(LTE至WCDMA切换成功率_Y)),2) as "LTE至WCDMA切换成功率",
        --sum(LTE至WCDMA切换成功率_X) as "LTE至WCDMA切换成功率_X",
        --sum(LTE至WCDMA切换成功率_Y) as "LTE至WCDMA切换成功率_Y",
                     
        sum(LTE_CSFB_REDIR请求次数) as "LTE_CSFB_REDIR请求次数",
        sum(aa.重定向请求次数_NoCSFB) as "重定向请求次数_NoCSFB",
        sum(E_RAB正常释放次数) as "E_RAB正常释放次数",

        Round(decode(sum(重定向比例_Nokia_Y), 0, 0, 100 * sum(重定向比例_Nokia_X) / 
                     sum(重定向比例_Nokia_Y)),2) as "重定向比例_Nokia"
        --sum(重定向比例_Nokia_X) as "重定向比例_Nokia_X",
        --sum(重定向比例_Nokia_Y) as "重定向比例_Nokia_Y",
...
FROM
    ...
    (SELECT sdatetime,
           TTime,
            kkkk.区域,
           kkkk.bts_version,
            Round(Decode(sum(M8009C6 + M8014C6 + M8014C14),0,0,100 * sum(M8009C7 + M8014C7 + M8014C19) /
                         sum(M8009C6 + M8014C6 + M8014C14)), 2) as LTE系统内切换成功率,     
            sum(M8009C7 + M8014C7 + M8014C19) as LTE系统内切换成功率_X,
            sum(M8009C6 + M8014C6 + M8014C14) as LTE系统内切换成功率_Y,
            
            sum(M8009C6) as eNB内切换请求次数,
            sum(M8009C7) as eNB内切换成功次数,
            Round(decode(sum(M8009C6), 0, 0, 100 * sum(M8009C7) / 
                         sum(M8009C6)),2) as eNB内切换成功率,
            sum(M8009C7) AS eNB内切换成功率_X,
            sum(M8009C6) AS eNB内切换成功率_Y,
            
            sum(M8014C6) as X2切换出请求次数,
            sum(M8014C7) as X2切换出成功次数,
            Round(decode(sum(M8014C6), 0, 0, 100 * sum(M8014C7) / 
                         sum(M8014C6)),2) as X2切换成功率,
            sum(M8014C7) as X2切换成功率_X,
            sum(M8014C6) as X2切换成功率_Y,

            sum(M8014C14) as S1切换出请求次数,
            sum(M8014C19) as S1切换出成功次数,
            Round(decode(sum(M8014C14), 0, 0, 100 * sum(M8014C19) /
                         sum(M8014C14)),2) as S1切换成功率,
            sum(M8014C19) as S1切换成功率_X,
            sum(M8014C14) as S1切换成功率_Y,

            sum(M8016C14) as LTE至WCDMA切换请求次数,
            sum(M8016C23) as LTE至WCDMA切换成功次数,
            Round(decode(sum(M8016C14), 0, 0, 100 * sum(M8016C23) / 
                         sum(M8016C14)),2) as LTE至WCDMA切换成功率,
            sum(M8016C23) as LTE至WCDMA切换成功率_X,
            sum(M8016C14) as LTE至WCDMA切换成功率_Y,
                         
            sum(M8016C11) as LTE_CSFB_REDIR请求次数,
            ...
            decode((CASE WHEN kkkk.bts_version='FL16' THEN 'FL16' WHEN kkkk.bts_version='FLF16' THEN 'FL16' WHEN kkkk.bts_version='FL16A' THEN 'FL16' WHEN kkkk.bts_version='TL16' THEN 'FL16' ELSE kkkk.bts_version END),'FL16',(decode((sum(M8006C255)+sum(M8006C258)+sum(M8006C6)+sum(M8006C7)+sum(M8006C260)),0,0,round((sum(M8006C258) - sum(M8016C11))/(sum(M8006C255)+sum(M8006C258)+sum(M8006C6)+sum(M8006C7)+sum(M8006C260))*100,2))), (decode((sum(M8006C10) + sum(M8006C15) + sum(M8006C6) + sum(M8006C7) + sum(M8006C180)),0,0,round((sum(M8006C15) - sum(M8016C11)) / (sum(M8006C10) + sum(M8006C15) + sum(M8006C6) +sum(M8006C7) + sum(M8006C180)) * 100,2)))) as 重定向比例_Nokia,
            decode((CASE WHEN kkkk.bts_version='FL16' THEN 'FL16' WHEN kkkk.bts_version='FLF16' THEN 'FL16' WHEN kkkk.bts_version='FL16A' THEN 'FL16' WHEN kkkk.bts_version='TL16' THEN 'FL16' ELSE kkkk.bts_version END),'FL16',sum(M8006C255 + M8006C258 + M8006C6 + M8006C7 + M8006C260),
                                           sum(M8006C10 + M8006C15 + M8006C6 + M8006C7 + M8006C180)) as 重定向比例_Nokia_Y,
            decode((CASE WHEN kkkk.bts_version='FL16' THEN 'FL16' WHEN kkkk.bts_version='FLF16' THEN 'FL16' WHEN kkkk.bts_version='FL16A' THEN 'FL16' WHEN kkkk.bts_version='TL16' THEN 'FL16' ELSE kkkk.bts_version END),'FL16',sum(M8006C258 - M8016C11),
                                           sum(M8006C15 - M8016C11)) as 重定向比例_Nokia_X
      ...
      FROM (SELECT M8013.sdatetime,
              ...
              FROM (select to_char(period_start_time, 'yyyymmdd') sdatetime,
                           ...
                           LNCEL_ID,
                           to_char(period_start_time, 'yyyymmdd')|| to_char(period_start_time, 'hh24') || LNCEL_ID cel_key_id,
                     ...
                     group by to_char(period_start_time, 'yyyymmdd'),
                              ...
                              LNCEL_ID,
                              to_char(period_start_time, 'yyyymmdd')|| to_char(period_start_time, 'hh24') || LNCEL_ID) M8001,
                   ...
                   and period_start_time < to_date(&end_datetime, 'yyyymmdd')
                      ...
                      group by 
                               to_char(period_start_time, 'yyyymmdd'),
                               to_char(period_start_time, 'hh24'),
                               LNCEL_ID,
                               to_char(period_start_time, 'yyyymmdd')|| to_char(period_start_time, 'hh24') || LNCEL_ID) M8006,
                   (select to_char(period_start_time, 'yyyymmdd') sdatetime,
                   to_char(period_start_time, 'hh24') TTime,
                           LNCEL_ID,
                           to_char(period_start_time, 'yyyymmdd') || to_char(period_start_time, 'hh24')|| LNCEL_ID cel_key_id,
                     ...
                     to_char(period_start_time, 'hh24'),
                              LNCEL_ID,
                              to_char(period_start_time, 'yyyymmdd') || to_char(period_start_time, 'hh24')|| LNCEL_ID) M8008,
                   (select to_char(period_start_time, 'yyyymmdd') sdatetime,
                   to_char(period_start_time, 'hh24') TTime,
                           LNCEL_ID,
                           to_char(period_start_time, 'yyyymmdd')|| to_char(period_start_time, 'hh24') || LNCEL_ID cel_key_id,
                     ...
                     to_char(period_start_time, 'hh24'),
                              LNCEL_ID,
                              to_char(period_start_time, 'yyyymmdd')|| to_char(period_start_time, 'hh24') || LNCEL_ID) M8009,
                   (select to_char(period_start_time, 'yyyymmdd') sdatetime,
                   to_char(period_start_time, 'hh24') TTime,
                            LNCEL_ID,
                            to_char(period_start_time, 'yyyymmdd') || to_char(period_start_time, 'hh24')|| LNCEL_ID cel_key_id,
                   ...
                   and period_start_time < to_date(&end_datetime, 'yyyymmdd')
                      ...
                      to_char(period_start_time, 'hh24'),
                               LNCEL_ID,
                               to_char(period_start_time, 'yyyymmdd')|| to_char(period_start_time, 'hh24') || LNCEL_ID
                   ...
                   and period_start_time < to_date(&end_datetime, 'yyyymmdd')
                      ...
                      to_char(period_start_time, 'hh24') ,
                               LNCEL_ID,
                               to_char(period_start_time, 'yyyymmdd')|| to_char(period_start_time, 'hh24') || LNCEL_ID) M8012,
                   (select to_char(period_start_time, 'yyyymmdd') sdatetime,
                           to_char(period_start_time, 'hh24') TTime,
                           LNCEL_ID,
                           to_char(period_start_time, 'yyyymmdd') || to_char(period_start_time, 'hh24')|| LNCEL_ID cel_key_id,
            ...
            ELSE NULL END) 区域,
                 ...
                 inner join c_lte_custom c on PMRAW.LNCEL_ID = c.lncel_objid
                     ...
                     where 
                      ...
                      period_start_time >=to_date(&start_datetime,'yyyymmdd')and period_start_time <to_date(&end_datetime,'yyyymmdd')       
            ...
            c.netmodel,
                   ...
                   and period_start_time < to_date(&end_datetime, 'yyyymmdd')
                      group by to_char(period_start_time, 'yyyymmdd'),
                         to_char(period_start_time, 'hh24'),
                               LNCEL_ID,
                               to_char(period_start_time, 'yyyymmdd') || to_char(period_start_time, 'hh24')|| LNCEL_ID) M8014,
                   (select to_char(period_start_time, 'yyyymmdd') sdatetime,
                   to_char(period_start_time, 'hh24') TTime,
                           LNCEL_ID,
                           to_char(period_start_time, 'yyyymmdd') || to_char(period_start_time, 'hh24')|| LNCEL_ID cel_key_id,
                     ...
                     to_char(period_start_time, 'hh24'),
                              LNCEL_ID,
                              to_char(period_start_time, 'yyyymmdd') || to_char(period_start_time, 'hh24')|| LNCEL_ID) M8015,
                   (select to_char(period_start_time, 'yyyymmdd') sdatetime,
                   to_char(period_start_time, 'hh24') TTime,
                           LNCEL_ID,
                           to_char(period_start_time, 'yyyymmdd') || to_char(period_start_time, 'hh24')|| LNCEL_ID cel_key_id,
                     ...
                     to_char(period_start_time, 'hh24') ,
                              LNCEL_ID,
                              to_char(period_start_time, 'yyyymmdd') || to_char(period_start_time, 'hh24')|| LNCEL_ID) M8016,
                   (select to_char(period_start_time, 'yyyymmdd') sdatetime,
                   to_char(period_start_time, 'hh24') TTime,
                           LNBTS_ID,
                           LNCEL_ID,
                     ...
                     to_char(period_start_time, 'hh24'),
                              ...
                              LNBTS_ID,
                              LNCEL_ID,
                              to_char(period_start_time, 'yyyymmdd') || to_char(period_start_time, 'hh24')|| LNCEL_ID) M8020
